 ...
 */
@Schema(description = "A paginated list of pullrequests.")
...
public class PaginatedPullrequests {
  ...
  @JsonProperty("values")
  private List<Pullrequest> values = null;

  public PaginatedPullrequests size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPullrequests page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPullrequests pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedPullrequests next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPullrequests previous(String previous) {
  ...
  **/
  ...
  public PaginatedPullrequests values(List<Pullrequest> values) {
    this.values = values;
    return this;
  }

  public PaginatedPullrequests addValuesItem(Pullrequest valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Pullrequest>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedPullrequests paginatedPullrequests = (PaginatedPullrequests) o;
    return Objects.equals(this.size, paginatedPullrequests.size) &&
        Objects.equals(this.page, paginatedPullrequests.page) &&
        Objects.equals(this.pagelen, paginatedPullrequests.pagelen) &&
        Objects.equals(this.next, paginatedPullrequests.next) &&
        Objects.equals(this.previous, paginatedPullrequests.previous) &&
        Objects.equals(this.values, paginatedPullrequests.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedPullrequests {\n");
