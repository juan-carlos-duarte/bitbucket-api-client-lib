 ...
 */
@Schema(description = "A paginated list of commit_file objects.")
...
public class PaginatedFiles {
  ...
  @JsonProperty("values")
  private List<CommitFile> values = null;
  ...
  **/
  ...
  public PaginatedFiles next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedFiles previous(String previous) {
  ...
  **/
  ...
  public PaginatedFiles values(List<CommitFile> values) {
    this.values = values;
    return this;
  }
  ...
  public PaginatedFiles addValuesItem(CommitFile valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<CommitFile>();
    }
  ...
  **/
  @Schema(description = "")
  public List<CommitFile> getValues() {
    return values;
  }

  public void setValues(List<CommitFile> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.size, paginatedFiles.size) &&
        Objects.equals(this.page, paginatedFiles.page) &&
        Objects.equals(this.pagelen, paginatedFiles.pagelen) &&
        Objects.equals(this.next, paginatedFiles.next) &&
