 ...
 */
@Schema(description = "A paginated list of workspaces.")
...
public class PaginatedWorkspaces {
  ...
  @JsonProperty("values")
  private List<Workspace> values = null;

  public PaginatedWorkspaces size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedWorkspaces page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedWorkspaces pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedWorkspaces next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedWorkspaces previous(String previous) {
  ...
  **/
  ...
  public PaginatedWorkspaces values(List<Workspace> values) {
    this.values = values;
    return this;
  }

  public PaginatedWorkspaces addValuesItem(Workspace valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Workspace>();
    }
  ...
  **/
  @Schema(description = "")
  public List<Workspace> getValues() {
    return values;
  }

  public void setValues(List<Workspace> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedWorkspaces paginatedWorkspaces = (PaginatedWorkspaces) o;
    return Objects.equals(this.size, paginatedWorkspaces.size) &&
        Objects.equals(this.page, paginatedWorkspaces.page) &&
        Objects.equals(this.pagelen, paginatedWorkspaces.pagelen) &&
        Objects.equals(this.next, paginatedWorkspaces.next) &&
        Objects.equals(this.previous, paginatedWorkspaces.previous) &&
        Objects.equals(this.values, paginatedWorkspaces.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedWorkspaces {\n");
