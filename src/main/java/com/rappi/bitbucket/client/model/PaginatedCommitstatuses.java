 ...
 */
@Schema(description = "A paginated list of commit status objects.")
...
public class PaginatedCommitstatuses {
  ...
  @JsonProperty("values")
  private List<Commitstatus> values = null;

  public PaginatedCommitstatuses size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedCommitstatuses page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedCommitstatuses pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedCommitstatuses next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedCommitstatuses previous(String previous) {
  ...
  **/
  ...
  public PaginatedCommitstatuses values(List<Commitstatus> values) {
    this.values = values;
    return this;
  }

  public PaginatedCommitstatuses addValuesItem(Commitstatus valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Commitstatus>();
    }
  ...
  **/
  @Schema(description = "")
  public List<Commitstatus> getValues() {
    return values;
  }

  public void setValues(List<Commitstatus> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedCommitstatuses paginatedCommitstatuses = (PaginatedCommitstatuses) o;
    return Objects.equals(this.size, paginatedCommitstatuses.size) &&
        Objects.equals(this.page, paginatedCommitstatuses.page) &&
        Objects.equals(this.pagelen, paginatedCommitstatuses.pagelen) &&
        Objects.equals(this.next, paginatedCommitstatuses.next) &&
        Objects.equals(this.previous, paginatedCommitstatuses.previous) &&
        Objects.equals(this.values, paginatedCommitstatuses.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedCommitstatuses {\n");
