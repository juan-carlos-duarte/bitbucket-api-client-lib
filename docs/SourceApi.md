...
------------- | ------------- | -------------
[**repositoriesWorkspaceRepoSlugFilehistoryNodePathGet**](SourceApi.md#repositoriesWorkspaceRepoSlugFilehistoryNodePathGet) | **GET** /repositories/{workspace}/{repo_slug}/filehistory/{node}/{path} | 
...
[**repositoriesWorkspaceRepoSlugSrcNodePathGet**](SourceApi.md#repositoriesWorkspaceRepoSlugSrcNodePathGet) | **GET** /repositories/{workspace}/{repo_slug}/src/{node}/{path} | 
...
//import com.rappi.bitbucket.client.api.SourceApi;
...
try {
    ...
    System.err.println("Exception when calling SourceApi#repositoriesWorkspaceRepoSlugFilehistoryNodePathGet");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling SourceApi#repositoriesWorkspaceRepoSlugSrcNodePathGet");
    e.printStackTrace();
}
```
