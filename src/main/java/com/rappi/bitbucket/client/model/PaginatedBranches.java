 ...
 */
@Schema(description = "A paginated list of branches.")
...
public class PaginatedBranches {
  ...
  @JsonProperty("values")
  private List<Branch> values = null;

  public PaginatedBranches size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedBranches page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedBranches pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedBranches next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedBranches previous(String previous) {
  ...
  **/
  ...
  public PaginatedBranches values(List<Branch> values) {
    this.values = values;
    return this;
  }

  public PaginatedBranches addValuesItem(Branch valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Branch>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedBranches paginatedBranches = (PaginatedBranches) o;
    return Objects.equals(this.size, paginatedBranches.size) &&
        Objects.equals(this.page, paginatedBranches.page) &&
        Objects.equals(this.pagelen, paginatedBranches.pagelen) &&
        Objects.equals(this.next, paginatedBranches.next) &&
        Objects.equals(this.previous, paginatedBranches.previous) &&
        Objects.equals(this.values, paginatedBranches.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedBranches {\n");
