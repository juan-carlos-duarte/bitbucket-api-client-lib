...
import com.rappi.bitbucket.client.model.Diffstat;
 ...
 */
@Schema(description = "A paginated list of diffstats.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-11-12T14:05:09.453-06:00[America/Mexico_City]")
public class PaginatedDiffstats {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<Diffstat> values = null;

  public PaginatedDiffstats size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedDiffstats page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedDiffstats pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedDiffstats next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedDiffstats previous(String previous) {
  ...
  **/
  ...
  public PaginatedDiffstats values(List<Diffstat> values) {
    this.values = values;
    return this;
  }

  public PaginatedDiffstats addValuesItem(Diffstat valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Diffstat>();
    }
  ...
  **/
  @Schema(description = "")
  public List<Diffstat> getValues() {
    return values;
  }

  public void setValues(List<Diffstat> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedDiffstats paginatedDiffstats = (PaginatedDiffstats) o;
    return Objects.equals(this.size, paginatedDiffstats.size) &&
        Objects.equals(this.page, paginatedDiffstats.page) &&
        Objects.equals(this.pagelen, paginatedDiffstats.pagelen) &&
        Objects.equals(this.next, paginatedDiffstats.next) &&
        Objects.equals(this.previous, paginatedDiffstats.previous) &&
        Objects.equals(this.values, paginatedDiffstats.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedDiffstats {\n");
