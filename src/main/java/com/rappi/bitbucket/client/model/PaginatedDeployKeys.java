 ...
 */
@Schema(description = "A paginated list of deploy keys.")
...
public class PaginatedDeployKeys {
  ...
  @JsonProperty("values")
  private List<DeployKey> values = null;
  ...
  **/
  ...
  public PaginatedDeployKeys next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedDeployKeys previous(String previous) {
  ...
  **/
  ...
  public PaginatedDeployKeys values(List<DeployKey> values) {
    this.values = values;
    return this;
  }
  ...
  public PaginatedDeployKeys addValuesItem(DeployKey valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<DeployKey>();
    }
  ...
  **/
  @Schema(description = "")
  public List<DeployKey> getValues() {
    return values;
  }

  public void setValues(List<DeployKey> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.size, paginatedDeployKeys.size) &&
        Objects.equals(this.page, paginatedDeployKeys.page) &&
        Objects.equals(this.pagelen, paginatedDeployKeys.pagelen) &&
        Objects.equals(this.next, paginatedDeployKeys.next) &&
