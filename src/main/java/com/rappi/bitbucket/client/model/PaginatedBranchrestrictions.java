 ...
 */
@Schema(description = "A paginated list of branch restriction rules.")
...
public class PaginatedBranchrestrictions {
  ...
  @JsonProperty("values")
  private List<Branchrestriction> values = null;

  public PaginatedBranchrestrictions size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedBranchrestrictions page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedBranchrestrictions pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedBranchrestrictions next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedBranchrestrictions previous(String previous) {
  ...
  **/
  ...
  public PaginatedBranchrestrictions values(List<Branchrestriction> values) {
    this.values = values;
    return this;
  }

  public PaginatedBranchrestrictions addValuesItem(Branchrestriction valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Branchrestriction>();
    }
  ...
  **/
  @Schema(description = "")
  public List<Branchrestriction> getValues() {
    return values;
  }

  public void setValues(List<Branchrestriction> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedBranchrestrictions paginatedBranchrestrictions = (PaginatedBranchrestrictions) o;
    return Objects.equals(this.size, paginatedBranchrestrictions.size) &&
        Objects.equals(this.page, paginatedBranchrestrictions.page) &&
        Objects.equals(this.pagelen, paginatedBranchrestrictions.pagelen) &&
        Objects.equals(this.next, paginatedBranchrestrictions.next) &&
        Objects.equals(this.previous, paginatedBranchrestrictions.previous) &&
        Objects.equals(this.values, paginatedBranchrestrictions.values);
  }
