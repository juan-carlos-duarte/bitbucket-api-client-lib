...
import com.rappi.bitbucket.client.model.Treeentry;
 ...
 */
@Schema(description = "A paginated list of commit_file and/or commit_directory objects.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-11-12T14:05:09.453-06:00[America/Mexico_City]")
public class PaginatedTreeentries {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<Treeentry> values = null;

  public PaginatedTreeentries size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedTreeentries page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedTreeentries pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedTreeentries next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedTreeentries previous(String previous) {
  ...
  **/
  ...
  public PaginatedTreeentries values(List<Treeentry> values) {
    this.values = values;
    return this;
  }

  public PaginatedTreeentries addValuesItem(Treeentry valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Treeentry>();
    }
  ...
  **/
  @Schema(description = "")
  public List<Treeentry> getValues() {
    return values;
  }

  public void setValues(List<Treeentry> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedTreeentries paginatedTreeentries = (PaginatedTreeentries) o;
    return Objects.equals(this.size, paginatedTreeentries.size) &&
        Objects.equals(this.page, paginatedTreeentries.page) &&
        Objects.equals(this.pagelen, paginatedTreeentries.pagelen) &&
        Objects.equals(this.next, paginatedTreeentries.next) &&
        Objects.equals(this.previous, paginatedTreeentries.previous) &&
        Objects.equals(this.values, paginatedTreeentries.values);
  }
