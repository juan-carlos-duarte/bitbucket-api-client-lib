...
import com.rappi.bitbucket.client.model.Ref;
 ...
 */
@Schema(description = "A paginated list of refs.")
...
public class PaginatedRefs {
  ...
  @JsonProperty("values")
  private List<Ref> values = null;

  public PaginatedRefs size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedRefs page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedRefs pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedRefs next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedRefs previous(String previous) {
  ...
  **/
  ...
  public PaginatedRefs values(List<Ref> values) {
    this.values = values;
    return this;
  }

  public PaginatedRefs addValuesItem(Ref valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Ref>();
    }
  ...
  **/
  @Schema(description = "")
  public List<Ref> getValues() {
    return values;
  }

  public void setValues(List<Ref> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedRefs paginatedRefs = (PaginatedRefs) o;
    return Objects.equals(this.size, paginatedRefs.size) &&
        Objects.equals(this.page, paginatedRefs.page) &&
        Objects.equals(this.pagelen, paginatedRefs.pagelen) &&
        Objects.equals(this.next, paginatedRefs.next) &&
        Objects.equals(this.previous, paginatedRefs.previous) &&
        Objects.equals(this.values, paginatedRefs.values);
  }
