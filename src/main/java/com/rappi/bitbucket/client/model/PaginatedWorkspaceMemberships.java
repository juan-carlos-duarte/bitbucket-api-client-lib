 ...
 */
@Schema(description = "A paginated list of workspace memberships.")
...
public class PaginatedWorkspaceMemberships {
  ...
  @JsonProperty("values")
  private List<WorkspaceMembership> values = null;

  public PaginatedWorkspaceMemberships size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedWorkspaceMemberships page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedWorkspaceMemberships pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedWorkspaceMemberships next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedWorkspaceMemberships previous(String previous) {
  ...
  **/
  ...
  public PaginatedWorkspaceMemberships values(List<WorkspaceMembership> values) {
    this.values = values;
    return this;
  }

  public PaginatedWorkspaceMemberships addValuesItem(WorkspaceMembership valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<WorkspaceMembership>();
    }
  ...
  **/
  @Schema(description = "")
  public List<WorkspaceMembership> getValues() {
    return values;
  }

  public void setValues(List<WorkspaceMembership> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedWorkspaceMemberships paginatedWorkspaceMemberships = (PaginatedWorkspaceMemberships) o;
    return Objects.equals(this.size, paginatedWorkspaceMemberships.size) &&
        Objects.equals(this.page, paginatedWorkspaceMemberships.page) &&
        Objects.equals(this.pagelen, paginatedWorkspaceMemberships.pagelen) &&
        Objects.equals(this.next, paginatedWorkspaceMemberships.next) &&
        Objects.equals(this.previous, paginatedWorkspaceMemberships.previous) &&
        Objects.equals(this.values, paginatedWorkspaceMemberships.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedWorkspaceMemberships {\n");
