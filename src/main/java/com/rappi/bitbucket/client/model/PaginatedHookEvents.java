...
import com.rappi.bitbucket.client.model.HookEvent;
 ...
 */
@Schema(description = "A paginated list of webhook types available to subscribe on.")
...
public class PaginatedHookEvents {
  ...
  @JsonProperty("values")
  private List<HookEvent> values = null;
  ...
  **/
  ...
  public PaginatedHookEvents addValuesItem(HookEvent valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<HookEvent>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.size, paginatedHookEvents.size) &&
        Objects.equals(this.page, paginatedHookEvents.page) &&
        Objects.equals(this.pagelen, paginatedHookEvents.pagelen) &&
        Objects.equals(this.next, paginatedHookEvents.next) &&
