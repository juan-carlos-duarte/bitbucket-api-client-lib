 ...
 */
@Schema(description = "A paginated list of commit comments.")
...
public class PaginatedCommitComments {
  ...
  @JsonProperty("values")
  private List<CommitComment> values = null;
  ...
  **/
  ...
  public PaginatedCommitComments next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedCommitComments previous(String previous) {
  ...
  **/
  ...
  public PaginatedCommitComments values(List<CommitComment> values) {
    this.values = values;
    return this;
  }
  ...
  public PaginatedCommitComments addValuesItem(CommitComment valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<CommitComment>();
    }
  ...
  **/
  @Schema(description = "")
  public List<CommitComment> getValues() {
    return values;
  }

  public void setValues(List<CommitComment> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.size, paginatedCommitComments.size) &&
        Objects.equals(this.page, paginatedCommitComments.page) &&
        Objects.equals(this.pagelen, paginatedCommitComments.pagelen) &&
        Objects.equals(this.next, paginatedCommitComments.next) &&
