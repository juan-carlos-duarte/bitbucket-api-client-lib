 ...
 */
@Schema(description = "A paged list of pipelines")
...
public class PaginatedPipelines {
  ...
  @JsonProperty("values")
  private List<Pipeline> values = null;
  ...
  public PaginatedPipelines page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPipelines values(List<Pipeline> values) {
    this.values = values;
    return this;
  }

  public PaginatedPipelines addValuesItem(Pipeline valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Pipeline>();
    }
  ...
  **/
  ...
  public List<Pipeline> getValues() {
    return values;
  }

  public void setValues(List<Pipeline> values) {
    this.values = values;
  }

  public PaginatedPipelines size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPipelines pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedPipelines next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPipelines previous(String previous) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedPipelines paginatedPipelines = (PaginatedPipelines) o;
    return Objects.equals(this.page, paginatedPipelines.page) &&
        Objects.equals(this.values, paginatedPipelines.values) &&
        Objects.equals(this.size, paginatedPipelines.size) &&
        Objects.equals(this.pagelen, paginatedPipelines.pagelen) &&
        Objects.equals(this.next, paginatedPipelines.next) &&
        Objects.equals(this.previous, paginatedPipelines.previous);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedPipelines {\n");
