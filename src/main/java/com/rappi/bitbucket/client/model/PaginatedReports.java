 ...
 */
@Schema(description = "A paginated list of reports.")
...
public class PaginatedReports {
  ...
  @JsonProperty("values")
  private List<Report> values = null;
  ...
  public PaginatedReports page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedReports values(List<Report> values) {
    this.values = values;
    return this;
  }

  public PaginatedReports addValuesItem(Report valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<Report>();
    }
  ...
  **/
  ...
  public PaginatedReports size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedReports pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedReports next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedReports previous(String previous) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedReports paginatedReports = (PaginatedReports) o;
    return Objects.equals(this.page, paginatedReports.page) &&
        Objects.equals(this.values, paginatedReports.values) &&
        Objects.equals(this.size, paginatedReports.size) &&
        Objects.equals(this.pagelen, paginatedReports.pagelen) &&
        Objects.equals(this.next, paginatedReports.next) &&
        Objects.equals(this.previous, paginatedReports.previous);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedReports {\n");
