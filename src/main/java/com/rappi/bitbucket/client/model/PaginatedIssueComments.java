 ...
 */
@Schema(description = "A paginated list of issue comments.")
...
public class PaginatedIssueComments {
  ...
  @JsonProperty("values")
  private List<IssueComment> values = null;

  public PaginatedIssueComments size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedIssueComments page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedIssueComments pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedIssueComments next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedIssueComments previous(String previous) {
  ...
  **/
  ...
  public PaginatedIssueComments values(List<IssueComment> values) {
    this.values = values;
    return this;
  }

  public PaginatedIssueComments addValuesItem(IssueComment valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<IssueComment>();
    }
  ...
  **/
  ...
  public void setValues(List<IssueComment> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedIssueComments paginatedIssueComments = (PaginatedIssueComments) o;
    return Objects.equals(this.size, paginatedIssueComments.size) &&
        Objects.equals(this.page, paginatedIssueComments.page) &&
        Objects.equals(this.pagelen, paginatedIssueComments.pagelen) &&
        Objects.equals(this.next, paginatedIssueComments.next) &&
        Objects.equals(this.previous, paginatedIssueComments.previous) &&
        Objects.equals(this.values, paginatedIssueComments.values);
  }
