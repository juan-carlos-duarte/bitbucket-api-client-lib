 ...
 */
@Schema(description = "A paginated list of issue changes.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-11-12T14:05:09.453-06:00[America/Mexico_City]")
public class PaginatedLogEntries {
  @JsonProperty("size")
  ...
  @JsonProperty("values")
  private List<IssueChange> values = null;

  public PaginatedLogEntries size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedLogEntries page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedLogEntries pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedLogEntries next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedLogEntries previous(String previous) {
  ...
  **/
  ...
  public PaginatedLogEntries values(List<IssueChange> values) {
    this.values = values;
    return this;
  }

  public PaginatedLogEntries addValuesItem(IssueChange valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<IssueChange>();
    }
  ...
  **/
  @Schema(description = "")
  public List<IssueChange> getValues() {
    return values;
  }

  public void setValues(List<IssueChange> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedLogEntries paginatedLogEntries = (PaginatedLogEntries) o;
    return Objects.equals(this.size, paginatedLogEntries.size) &&
        Objects.equals(this.page, paginatedLogEntries.page) &&
        Objects.equals(this.pagelen, paginatedLogEntries.pagelen) &&
        Objects.equals(this.next, paginatedLogEntries.next) &&
        Objects.equals(this.previous, paginatedLogEntries.previous) &&
        Objects.equals(this.values, paginatedLogEntries.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedLogEntries {\n");
