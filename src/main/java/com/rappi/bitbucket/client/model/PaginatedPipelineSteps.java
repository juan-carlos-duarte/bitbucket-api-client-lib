 ...
 */
@Schema(description = "A paged list of pipeline steps.")
...
public class PaginatedPipelineSteps {
  ...
  @JsonProperty("values")
  private List<PipelineStep> values = null;
  ...
  **/
  ...
  public PaginatedPipelineSteps addValuesItem(PipelineStep valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<PipelineStep>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.page, paginatedPipelineSteps.page) &&
        ...
        Objects.equals(this.next, paginatedPipelineSteps.next) &&
