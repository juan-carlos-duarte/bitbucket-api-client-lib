 ...
 */
@Schema(description = "A paginated list of SSH keys.")
...
public class PaginatedSshUserKeys {
  ...
  @JsonProperty("values")
  private List<SshAccountKey> values = null;
  ...
  **/
  ...
  public PaginatedSshUserKeys next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedSshUserKeys previous(String previous) {
  ...
  **/
  ...
  public PaginatedSshUserKeys values(List<SshAccountKey> values) {
    this.values = values;
    return this;
  }
  ...
  public PaginatedSshUserKeys addValuesItem(SshAccountKey valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<SshAccountKey>();
    }
  ...
  **/
  @Schema(description = "")
  public List<SshAccountKey> getValues() {
    return values;
  }

  public void setValues(List<SshAccountKey> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.size, paginatedSshUserKeys.size) &&
        Objects.equals(this.page, paginatedSshUserKeys.page) &&
        Objects.equals(this.pagelen, paginatedSshUserKeys.pagelen) &&
        Objects.equals(this.next, paginatedSshUserKeys.next) &&
