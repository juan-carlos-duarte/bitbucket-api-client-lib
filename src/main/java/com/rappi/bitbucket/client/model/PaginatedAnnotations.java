 ...
 */
@Schema(description = "A paginated list of annotations.")
...
public class PaginatedAnnotations {
  ...
  @JsonProperty("values")
  private List<ReportAnnotation> values = null;
  ...
  public PaginatedAnnotations page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedAnnotations values(List<ReportAnnotation> values) {
    this.values = values;
    return this;
  }

  public PaginatedAnnotations addValuesItem(ReportAnnotation valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<ReportAnnotation>();
    }
  ...
  **/
  ...
  public List<ReportAnnotation> getValues() {
    return values;
  }

  public void setValues(List<ReportAnnotation> values) {
    this.values = values;
  }

  public PaginatedAnnotations size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedAnnotations pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedAnnotations next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedAnnotations previous(String previous) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedAnnotations paginatedAnnotations = (PaginatedAnnotations) o;
    return Objects.equals(this.page, paginatedAnnotations.page) &&
        Objects.equals(this.values, paginatedAnnotations.values) &&
        Objects.equals(this.size, paginatedAnnotations.size) &&
        Objects.equals(this.pagelen, paginatedAnnotations.pagelen) &&
        Objects.equals(this.next, paginatedAnnotations.next) &&
        Objects.equals(this.previous, paginatedAnnotations.previous);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedAnnotations {\n");
